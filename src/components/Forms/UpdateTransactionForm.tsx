...
export default function UpdateTransactionForm({
	...
	const {
		...
		handleSubmit,
		formState: { errors },
	} = useForm<ApiTransaction>({
		defaultValues: currentTransactionForUpdate,
	});

	const mutation = useMutation(
		(newTransaction: ApiTransaction): Promise<any> => {
	...
	const onSubmit: SubmitHandler<ApiTransaction> = (data) => {
		console.log(data);
